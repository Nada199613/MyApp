...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().departmentName(DEFAULT_DEPARTMENT_NAME).jobName(DEFAULT_JOB_NAME);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().departmentName(UPDATED_DEPARTMENT_NAME).jobName(UPDATED_JOB_NAME);
        return department;
    }
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getJobName()).isEqualTo(DEFAULT_JOB_NAME);
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).jobName(UPDATED_JOB_NAME);
        ...
        assertThat(testDepartment.getJobName()).isEqualTo(UPDATED_JOB_NAME);
    }
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).jobName(UPDATED_JOB_NAME);
